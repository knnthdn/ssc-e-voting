...
export type PartylistSortBy = "latest" | "oldest" | "name";

const SORT_OPTIONS: { value: PartylistSortBy; label: string }[] = [
  { value: "latest", label: "Latest" },
  { value: "oldest", label: "Oldest" },
  { value: "name", label: "Name" },
];

export default function SortByPartylist({
  value,
  onChange,
}: {
  value: PartylistSortBy;
  onChange: (value: PartylistSortBy) => void;
}) {
